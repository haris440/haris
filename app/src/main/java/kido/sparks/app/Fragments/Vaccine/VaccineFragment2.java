...
public class VaccineFragment2 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       pending=view.findViewById(R.id.pending);
        ...
        pending.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference refvaccine = FirebaseDatabase.getInstance().getReference().child("Parents").child("" + mAuth.getCurrentUser().getUid().toString()).child("Childs").child("" +pp.getKey()).child("vaccine2").child("month1");
